...
# -----------------------------------------------------------------------------------------------------------------------------------------------------
print("# TEMPOS DE ESPERA MÍNIMOS, MÉDIOS E MÁXIMOS")
print("--------------------------------------------")
tempos_parciais_fase_1,tempos_parciais_fase_2,tempos_parciais_fase_3,tempos_globais = calcular_tempos_espera(utentes,num_utentes)
